...
public class Server
{
  ...
  public void registar( String name,String nick,byte[] pass )
  {
    ...
    public void add_Games()
    {
      ...
      this.perguntas.add( new Pergunta( 
            "0000002.mp3","000002.jpg",new String[]{"Relacione esta canção com uma das seguintes palavras:","Microsoft","Adobe","Linux"},2 ));
      this.perguntas.add( new Pergunta( 
            "0000003.mp3","000003.jpg",new String[]{"Qual destas palavras não aparece no poema deste fado?","Lamento","Tormento","Momento"},3 ));
      this.perguntas.add( new Pergunta( 
            "0000004.mp3","000004.jpg",new String[]{"Qual destes países não tem relação com o cantor desta canção?","Portugal","Irão","Inglaterra"},3 ));
      this.perguntas.add( new Pergunta( 
            "0000005.mp3","000005.jpg",new String[]{"Que outra arte é referida no poema desta canção?","Pintura","Escultura","Literatura"},1 ));
      this.perguntas.add( new Pergunta(
            "0000006.mp3","000006.jpg",new String[]{"Em que década do século passado foi publicada esta canção?","Década de 60","Década de 70","Década de 80"},2 ));
      this.perguntas.add( new Pergunta( 
            "0000007.mp3","000007.jpg",new String[]{"Quem escreveu a letra desta canção?","Carlos Fausto Dias","Guzzetti Bordalo","Correia de Oliveira"},1 ));
      this.perguntas.add( new Pergunta( 
            "0000008.mp3","000008.jpg",new String[]{"De que ópera é esta canção?","Otelo","La bohéme","The fairy queen"},3 ));
      this.perguntas.add( new Pergunta(
            "0000009.mp3","000009.jpg",new String[]{"Como se chama este trecho musical?","Glass","Metamorphosis","Mad Rush"},3 ));
      this.perguntas.add( new Pergunta( 
            "0000010.mp3","000010.jpg",new String[]{"Este concerto foi gravado em que cidade?","Colónia","Viena","Paris"},1 ));
    }
